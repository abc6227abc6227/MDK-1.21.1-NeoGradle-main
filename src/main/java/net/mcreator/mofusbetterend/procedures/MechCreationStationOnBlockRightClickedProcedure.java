...
public class MechCreationStationOnBlockRightClickedProcedure {
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        boolean nautilusValid =
                slot0.getItem() == MofusBetterEndModItems.NAUTILUS_SUB_BLUEPRINT.get() &&
                        slot2.getItem() == Blocks.GLASS.asItem() &&
                        slot3.getItem() == Blocks.GLASS.asItem() &&
                        slot5.getItem() == MofusBetterEndModItems.TITANIUM_INGOT.get() &&
                        slot6.getItem() == Blocks.GLASS.asItem() &&
                        slot7.getItem() == Blocks.GLASS.asItem() &&
                        slot9.getItem() == MofusBetterEndModItems.TITANIUM_INGOT.get() &&
                        slot10.getItem() == MofusBetterEndModItems.TITANIUM_INGOT.get() &&
                        slot11.getItem() == MofusBetterEndModItems.TITANIUM_INGOT.get() &&
                        slot12.getItem() == MofusBetterEndModItems.TITANIUM_INGOT.get() &&
                        slot13.getItem() == MofusBetterEndModItems.NAUTILUS_THRUSTER.get() &&
                        slot14.getItem() == MofusBetterEndModItems.NAUTILUS_THRUSTER.get() &&
                        slot15.getItem() == MofusBetterEndModItems.NAUTILUS_THRUSTER.get() &&
                        slot16.getItem() == MofusBetterEndModItems.NAUTILUS_THRUSTER.get();
    ...
    private static void startNautilusCrafting(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        // 400 ticks (20秒) 后重置动画
        MofusBetterEndMod.queueServerWork(400, () -> {
            BlockState currentState = world.getBlockState(pos);
            world.setBlock(pos, currentState.setValue(MechCreationStationBlock.ANIMATION, 0), 3);
        });

        // 380 ticks (19秒) 后生成实体
        MofusBetterEndMod.queueServerWork(380, () -> {
            if (world instanceof ServerLevel serverLevel) {
                MofusBetterEndModEntities.NAUTILUS_SUB.get().spawn(
                        serverLevel,
                        pos.above(2),
